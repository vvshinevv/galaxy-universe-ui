...
export default {
    name: "ContentList",
    components: {ContentsToonModal, Footer},
    props:{
        showContentsModal: {
            type: Boolean,
            default: false,
    ...
    setup() {
        const state = reactive({
            ...
            titleUrl: require("@/assets/image/region3/toonList/toon_title.png"),
            imgUrl: [
                {
                    src: require("@/assets/image/region3/toonList/list1.png"),
                    key:1,
                },
                {
                    src: require("@/assets/image/region3/toonList/list2.png"),
                    key:2,
                },
                {
                    src: require("@/assets/image/region3/toonList/list3.png"),
                    key:null,
                },
                {
                    src: require("@/assets/image/region3/toonList/list4.png"),
                    key:null,
                },
            ],
            showModal: false,
