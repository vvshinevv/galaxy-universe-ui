<template>
    <div class="content-modal-list" :class="{ on: showContentsModal === true }">
        ...
        <div  class="content-modal-box">
            <h3 class="content-list-title"><img :src="titleUrl"><br/><img :src="titleUrl2"></h3>
...
import ContentsModal from "@/components/region2/ContentsModal";

export default {
    name: "ContentList",
    components: {ContentsModal, ContentsToonModal, Footer},
    props:{
        showContentsModal: {
            type: Boolean,
            default: false,
    ...
    emits: ["update:visible"],
        ...
        const state = reactive({
            ...
            titleUrl: require("@/assets/image/region2/toonList/toon_title.png"),
            titleUrl2: require("@/assets/image/region2/toonList/toon_title2.png"),
            imgUrl: [
                {
                    src: require("@/assets/image/region2/toonList/list1.png"),
                    key:1,
                },
                {
                    src: require("@/assets/image/region2/toonList/list3.png"),
                    key:null,
                },
                {
                    src: require("@/assets/image/region2/toonList/list2.png"),
                    key:null,
                },
                {
                    src: require("@/assets/image/region2/toonList/list2.png"),
